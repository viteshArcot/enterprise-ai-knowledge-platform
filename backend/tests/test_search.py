...
async def test_search_valid_2048d_embeddings(search_service, mock_chunk_repo, mock_embedding_gateway):
    ...
    mock_chunk_repo.find_similar.assert_called_once_with(mock_embedding, limit=5, page_number=None, document_ids=None)
...
async def test_search_page_aware_query(search_service, mock_chunk_repo, mock_embedding_gateway):
    ...
    mock_chunk_repo.find_similar.assert_called_once_with(mock_embedding, limit=5, page_number=20, document_ids=None)
